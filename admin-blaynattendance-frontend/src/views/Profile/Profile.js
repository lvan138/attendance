        ...
        <TabContent activeTab={this.state.activeTab} className="border-bottom-0">
          <TabPane tabId="1">
            <Form>
              <Row>
                <Col xs="12">
                  ...
                  <FormGroup>
                    ...
                    <Row>
                    <Col xs="12" sm="5">
                    <Input className="form-control1" type="text" id="address" placeholder='Địa chỉ' defaultValue={user.address} />
                    </Col>
                    </Row>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <Row>
                    <Col xs="12" sm="5">
                    <Input className="form-control1" type="text" id="phone" placeholder='Số điện thoại'  defaultValue={user.phone_number} />
                    </Col>
                    </Row>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <Row>
                    <Col xs="12" sm="5">
                    <Input className="form-control1" type="text" id="email" placeholder='Email' defaultValue={user.email} />
                    </Col>
                    </Row>
                  </FormGroup>
                  {/* <FormGroup>
                    <Label htmlFor="name" className="text-blayn">Nhóm nhân viên</Label>
                    <Row>
                    <Col xs="12" sm="5">
                    <Input className="form-control-readonly" type="text" id="group" placeholder="Phục vụ" readOnly/>
                    </Col>
                    </Row>
                  </FormGroup> */}
                </Col>
              ...
              <Row>
                <Col xs="12" sm="5">
                  <Button type="submit" className="btn-primary1">Save changes</Button> &nbsp;&nbsp;
