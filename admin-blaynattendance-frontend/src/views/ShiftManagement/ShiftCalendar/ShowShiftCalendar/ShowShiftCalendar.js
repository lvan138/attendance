      ...
      <div >
        <Row>
            ...
            <Col xs="12" sm="12" md="8">
                ...
                <Link to={"/xep-ca/"+event.id} className="shift-change" >Xếp ca</Link>
                </div>
            </Col>
        </Row>
      </div>
...
class ShowShiftCalendar extends React.Component{
    constructor(props) {
        super(props);
...
ShowShiftCalendar = connect(mapStateToProps)(ShowShiftCalendar)
export default ShowShiftCalendar